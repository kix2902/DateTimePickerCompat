...
public abstract class TouchExplorationHelper<T> extends AccessibilityNodeProviderCompat {
	 ...
	 * <p>
	 * You <b>must</b> call this method after adding or removing items from the parent view.
	 * </p>
	 */
	 ...
	 * {@link #populateNodeForItem(Object, AccessibilityNodeInfoCompat)} have changed.
	 * </p>
	 * 
	 * @param item
	 */
		...
		switch (action) {
			case AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS:
				if (mFocusedItemId != virtualViewId) {
					...
					sendEventForItem(item, AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUSED);
					handled = true;
				}
				break;
	 ...
	 * {@link AccessibilityNodeInfoCompat#ACTION_CLEAR_ACCESSIBILITY_FOCUS}, so typically a
	 * developer only needs to handle actions added manually in the {
	 * {@link #populateNodeForItem(Object, AccessibilityNodeInfoCompat)} method.
	 * </p>
	 * 
	 * @param item
	 ...
	 * @param arguments
	 *            Arguments for the action, or optionally {@code null}.
	 ...
	 * 
	 * @param item
	 *            The item for which to populate the event.
	 * @param event
	 ...
	 * <ul>
	 * <li>populate the event text using {@link AccessibilityNodeInfoCompat#setText(CharSequence)}
	 * or {@link AccessibilityNodeInfoCompat#setContentDescription(CharSequence)}</li>
	 * <li>set the item's parent-relative bounds using
	 * {@link AccessibilityNodeInfoCompat#setBoundsInParent(Rect)}
	 * </ul>
	 * 
	 * @param item
	 *            The item for which to populate the node.
	 * @param node
	 ...
	 * <p>
	 * The result of this method is cached until the developer calls {@link #invalidateParent()}.
	 * </p>
	 * 
	 * @param items
	 ...
	 * 
	 * @param x
	 *            The parent-relative x coordinate.
	 * @param y
	 *            The parent-relative y coordinate.
	 ...
	 * <p>
	 * This result of this method must be consistent with {@link #getItemForId(int)}.
	 * </p>
	 * 
	 * @param item
	 *            The item whose identifier to return.
