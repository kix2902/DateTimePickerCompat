...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
	 ...
	 *            key is not legal to start with. Or, pass in -1 to get into keyboard mode without a
	 *            starting
	 *            key.
	 */
	 ...
	 *            may then be used for the caller to know whether zeros had been explicitly entered
	 *            as either
	 *            hours of minutes. This is helpful for deciding whether to show the dashes, or
	 *            actual 0's.
