...
public class RadialSelectorView extends View {
	 ...
	 *            whether the circle's center is moved up slightly to make room for the AM/PM
	 *            circles.
	 ...
	 * @param isInnerCircle
	 *            Whether the selection should be in the inner circle or outer. Will be
	 *            ignored if hasInnerCircle was initialized to false.
	 * @param forceDrawDot
	 *            Whether to force the dot in the center of the selection circle to be
	 *            drawn. If false, the dot will be drawn only when the degrees is not a multiple of
	 *            30, i.e.
