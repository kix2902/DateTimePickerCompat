...
public class SimpleMonthView extends View {
	...
	/**
	 * These params can be passed into the view to control how it appears. {@link #VIEW_PARAMS_WEEK}
	 * is the only required field, though the default
	...
	/**
	 * This sets one of the days in this view as selected {@link Time#SUNDAY} through
	 * {@link Time#SATURDAY}.
	 */
	 ...
	 * 
	 * @param day
	 *            A time object representing the day that was clicked
	 */
	 ...
	 * @return {@code false} if the date is not valid for this month view, or {@code true} if the
	 *         date received focus
	 */
	...
	private class MonthViewNodeProvider extends TouchExplorationHelper<CalendarDay> {
		 ...
		 * 
		 * @param item
		 *            The time object to generate a description for
